...
```json
{
  ...
  "spans": [
    ...
    { "id": "codex_custom_abc_round_turn_1", "parentId": "codex_custom_abc_root", "roundId": "turn_1", "type": "round" },
...
runs in that session append a new `round` span and a child `chat` span under the
same trace.
